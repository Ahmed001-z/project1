    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="{{url('company/create')}}"><i class="icon-people"></i> إضافة شركة</a>
                <a class="nav-link" href="{{url('company/index')}}"><i class="icon-user-following"></i> عرض الشركات</a>
                <a class="nav-link" href="{{url('majors/create')}}"><i class="icon-user-following"></i> اضافة تخصص</a>
                <a class="nav-link" href="{{url('majors/index')}}"><i class="icon-user-following"></i> عرض التخصصات</a>
                <a class="nav-link" href="{{url('student/create')}}"><i class="icon-user-following"></i> إضافة الطالب</a>
                <a class="nav-link" href="{{url('student/index')}}"><i class="icon-user-following"></i>هرض الطلاب</a>
            </li>
...
<footer class="footer">
        <span class="text-left">
            <a href="https://www.facebook.com/profile.php">ahmed</a> &copy;حقوق لبنشر محفوظة
        </span>
...
<script src="{{ asset('asset/s/libs/pace.min.js') }}j"></script>
